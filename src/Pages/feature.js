...
export default function Feature() {
  ...
  <div class="container mx-auto flex px-5 py-10 justify-between flex-wrap items-center">
    ...
    <h2 class="font-poppins text-base font-medium leading-8 tracking-wider text-left text-[#1488CC]">Featured Residentials</h2>
                <h1 class="font-poppins xl:text-[45px] lg:text-[45px] md:text-[45px] text-[35px] text-black font-semibold leading-16 tracking-tighter text-left mt-3" style={{lineHeight:"1.2"}}>8486 E. Gulf Street New Doha</h1>    
                {/* 1*/}
  ...
  <div className="flex items-center">
    ...
    <div className=" ml-2 ">
      <h1 className="text-xl font-medium text-gray-700 capitalize dark:text-white">3 Beds</h1>
    </div>
  </div>
  ...
  <div className="flex items-center">
    ...
    <div className="ml-2 ">
      <h1 className="text-xl font-medium text-gray-700 capitalize dark:text-white">3 Baths</h1>
    </div>
  </div>
</div>
  ...
  <div className="flex items-center">
    ...
    <div className="ml-2">
      ...
      <button class="flex  text-white bg-[#1488CC] border-0 py-2 px-6  rounded mt-8">View More</button>
        <h1 class="mb-[5px] xl:ml-10 lg:ml-10 md:ml-10 ml-5 text-[20px] text-black font-bold  ">QAR 3,500,000</h1> 
      </div>
